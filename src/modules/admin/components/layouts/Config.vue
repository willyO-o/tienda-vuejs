<template>
    <div class="fixed-plugin" :class="clases()">
        <a class="fixed-plugin-button text-dark position-fixed px-3 py-2" @click="mostrarMenu">
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3">
                ...
                <div class="float-end mt-4">
                    <button class="btn btn-link text-dark p-0 fixed-plugin-close-button" @click="mostrar = false">
